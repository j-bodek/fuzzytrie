...
from fuzzytrie import Trie
from fuzzytrie import LevenshteinAutomatonBuilder as LevenshteinAutomatonBuilderPy
from fuzzytrie_rs import LevenshteinAutomatonBuilder
...
def test_automaton(queries, words):
    ...
    builderpy = LevenshteinAutomatonBuilderPy(d)
    ...
    for q in queries:
        ...
        t2, bf_matches = timeit(automaton_matches, query=q, builder=builderpy, trie=t)
        ...
        ), f"Returned matches differ query: {q}, automaton matches: {a_matches}, brute force matches: {bf_matches}"
